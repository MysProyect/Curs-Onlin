<div class="container">
	...
	<div class="text-center display-5">Subir recursos a esta seccion del curso
		...
		<form wire:submit.prevent="upload_save">
			...
			<div class="row">
				<div class="col-md-6">
					<div class="form-group mb-4">
						...
						@for($i = 0; $i < $fields; $i++)
							<input type="file" id="downloads" wire:model="files" class="form-control mb-2" accept=".png, .jpg, .jpej, .mp3, .pdf, .mp4, .MPEG-4, .zip, .rar">
						@endfor
					
					</div>
					<div class="form-group">
						<a href="#" class="btn btn-primary" wire:click.prevent="AddField"><b>++</b></a>
					</div>
				</div>
			</div>
			...
			<div class="form-group">
		    	<label class="text-primary display-6">¿Tienes un sitio web?</label>
		    	<input type="url" wire:model="url" class="form-control" placeholder="https://www.google.com/">
			</div>

				<div align="center" class="form-group">
		    	<label>Nota
		    		<textarea class="nav-link form-control" wire:name="texto" rows="3"  cols="200" placeholder="Escriba informacion que considere importante o de referencia para esta seccion"></textarea>
		    	</label>
			</div>
